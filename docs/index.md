...
## [Nightly Build (master branch)](https://github.com/form-dev/form/tree/bbd9a7ee7ba81fa4f56bc7cd91cfcdfee64a4c3a)
- [FORM 5.0.0-beta.1-208-gbbd9a7e Reference manual](master/manual) (also in [PDF](master/form-5.0.0-beta.1-208-gbbd9a7e-manual.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-208-gbbd9a7e-manual-html.tar.gz))
- [FORM 5.0.0-beta.1-208-gbbd9a7e Developer's reference manual](master/devref) (also in [PDF](master/form-5.0.0-beta.1-208-gbbd9a7e-devref.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-208-gbbd9a7e-devref-html.tar.gz))
- [FORM 5.0.0-beta.1-208-gbbd9a7e API reference](master/doxygen) (also in [PDF](master/form-5.0.0-beta.1-208-gbbd9a7e-doxygen.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-208-gbbd9a7e-doxygen-html.tar.gz))
