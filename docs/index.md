...
## [Nightly Build (master branch)](https://github.com/form-dev/form/tree/fe34bd1c1746caf1f8ea3417a86ccfd77fa26672)
- [FORM 5.0.0-beta.1-316-gfe34bd1 Reference manual](master/manual) (also in [PDF](master/form-5.0.0-beta.1-316-gfe34bd1-manual.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-316-gfe34bd1-manual-html.tar.gz))
- [FORM 5.0.0-beta.1-316-gfe34bd1 Developer's reference manual](master/devref) (also in [PDF](master/form-5.0.0-beta.1-316-gfe34bd1-devref.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-316-gfe34bd1-devref-html.tar.gz))
- [FORM 5.0.0-beta.1-316-gfe34bd1 API reference](master/doxygen) (also in [PDF](master/form-5.0.0-beta.1-316-gfe34bd1-doxygen.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-316-gfe34bd1-doxygen-html.tar.gz))
