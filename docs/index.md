...
## [Nightly Build (master branch)](https://github.com/form-dev/form/tree/afebe6619b831788e84b5e81f684798842bd41a1)
- [FORM 5.0.0-beta.1-255-gafebe66 Reference manual](master/manual) (also in [PDF](master/form-5.0.0-beta.1-255-gafebe66-manual.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-255-gafebe66-manual-html.tar.gz))
- [FORM 5.0.0-beta.1-255-gafebe66 Developer's reference manual](master/devref) (also in [PDF](master/form-5.0.0-beta.1-255-gafebe66-devref.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-255-gafebe66-devref-html.tar.gz))
- [FORM 5.0.0-beta.1-255-gafebe66 API reference](master/doxygen) (also in [PDF](master/form-5.0.0-beta.1-255-gafebe66-doxygen.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-255-gafebe66-doxygen-html.tar.gz))
