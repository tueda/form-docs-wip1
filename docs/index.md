...
## [Nightly Build (master branch)](https://github.com/form-dev/form/tree/7ed28803063e58cfd0d038f458d620781076a045)
- [FORM 5.0.0-beta.1-246-g7ed2880 Reference manual](master/manual) (also in [PDF](master/form-5.0.0-beta.1-246-g7ed2880-manual.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-246-g7ed2880-manual-html.tar.gz))
- [FORM 5.0.0-beta.1-246-g7ed2880 Developer's reference manual](master/devref) (also in [PDF](master/form-5.0.0-beta.1-246-g7ed2880-devref.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-246-g7ed2880-devref-html.tar.gz))
- [FORM 5.0.0-beta.1-246-g7ed2880 API reference](master/doxygen) (also in [PDF](master/form-5.0.0-beta.1-246-g7ed2880-doxygen.pdf) or [an HTML tarball](master/form-5.0.0-beta.1-246-g7ed2880-doxygen-html.tar.gz))
